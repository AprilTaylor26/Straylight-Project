...
(1, 'NovaStrike', 'novastrike@heliosnet.2147', 'HASH_ABC123',
    TO_TIMESTAMP('2147-03-01 14:22:10', 'YYYY-MM-DD HH24:MI:SS'), 'Active'),
(2, 'IonDrifter', 'iondrifter@heliosnet.2147', 'HASH_DEF456',
    TO_TIMESTAMP('2147-03-02 09:15:44', 'YYYY-MM-DD HH24:MI:SS'), 'Active'),
(3, 'QuantumShade', 'quantumshade@heliosnet.2147', 'HASH_GHI789',
    TO_TIMESTAMP('2147-03-03 18:03:21', 'YYYY-MM-DD HH24:MI:SS'), 'Active'),
(4, 'RiftRunner', 'riftrunner@heliosnet.2147', 'HASH_JKL012',
    TO_TIMESTAMP('2147-03-04 20:14:55', 'YYYY-MM-DD HH24:MI:SS'), 'Suspended'),
(5, 'HelixShade', 'helixshade@heliosnet.2147', 'HASH_MNO345',
    TO_TIMESTAMP('2147-03-05 13:22:11', 'YYYY-MM-DD HH24:MI:SS'), 'Active');
...
(101, 1, 'NovaStrike', 'Helios Sector', 'Damage',
    'Frontline strike operative specializing in plasma engagements.'),
(102, 2, 'IonDrifter', 'Outer Colonies', 'Stealth',
    'Nomadic infiltrator known for silent orbital breaches.'),
(103, 3, 'QuantumShade', 'Rift Cluster', 'Support',
    'Temporal analyst assisting squads with predictive combat modeling.'),
(104, 4, 'RiftRunner', 'Helios Sector', 'Damage',
    'High-speed operative trained in wormhole traversal.'),
(105, 5, 'HelixShade', 'Crystal Expanse', 'Tank',
    'Heavy-frame pilot with reinforced alloy exosuits.');

------------------------------------------------------------
-- PLAYER SETTINGS (Corrected)
------------------------------------------------------------
