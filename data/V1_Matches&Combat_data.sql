...
-- Match 1 (Team-based)
(1, 1, 1, 1, 101, 320), -- NovaStrike as Vanguard-9
(2, 1, 2, 4, 101, 280), -- IonDrifter as Spectre-Unit
(3, 1, 4, 2, 102, 410), -- RiftRunner as EmberCore
(4, 1, 5, 5, 102, 390), -- HelixShade as Titanfall-Prime

-- Match 2 (Solo Skirmish)
(5, 2, 3, 3, NULL, 150), -- QuantumShade as Aurora-LX
